...
def main():
    ...
    dirlist = os.listdir("DATASET/Dataset_ChestXray14/reports/valid")
    for i, file in enumerate(dirlist):
        if i >= VIS_NUM:
            break
        file_path = os.path.join("DATASET/Dataset_ChestXray14/reports/valid", file)
    ...
    save_dir = f'assets/datasets/ChestXray14-256_features-{version.split("/")[-1]}/run_vis'
