...
import libs.clip
from datasets import ISIC2018Database
import argparse
...
def main(resolution=256):
    ...
    if args.split == "train":
        ...
        #                      size=resolution)
        datas = ISIC2018Database(root='/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/public/T2I_datasets/ISIC/ISIC2018',
                                    csv_file='/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/public/T2I_datasets/ISIC/ISIC2018/TrainingGroundTruth.csv',
                                    size=resolution,
                                    mode='train')
        save_dir = f'assets/datasets/ISIC2018-{resolution}_features-{version.split("/")[-1]}/train'
    elif args.split == "test":
        # datas = ChestXray14Database(root='/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/datasets/ChestXray14',
        #                      csv_file='/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/datasets/ChestXray14/reports/valid_11_1.csv',
        #                      size=resolution)
        datas = ISIC2018Database(root='/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/public/T2I_datasets/ISIC/ISIC2018',
                                    csv_file='/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/public/T2I_datasets/ISIC/ISIC2018/TestGroundTruth.csv',
                                    size=resolution,
                                    mode='test')
        save_dir = f'assets/datasets/ISIC2018-{resolution}_features-{version.split("/")[-1]}/test'
    else:
