...
def main(resolution=256):
    ...
    if args.split == "train":
        ...
        #                      size=resolution)
        datas = ChestXray14Database(root='DATASET/Dataset_ChestXray14/ChestXray14',
                             csv_file ='DATASET/Dataset_ChestXray14/ChestXray14/train_11_1.csv',
                             size=resolution,
                             mode='train')
        save_dir = f'assets/datasets/ChestXray14-{resolution}_features/train'
    elif args.split == "val":
        # datas = ChestXray14Database(root='/cpfs01/projects-HDD/cfff-906dc71fafda_HDD/gbw_21307130160/datasets/ChestXray14',
        ...
        datas = ChestXray14Database(root='DATASET/Dataset_ChestXray14/ChestXray14',
                             ...
                             size=resolution,
                             mode='valid')
        save_dir = f'assets/datasets/ChestXray14-{resolution}_features/val'
    else:
