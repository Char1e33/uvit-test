...
def get_config():
    ...
    config.model_name_or_path = "c8f97547ff6dd96debf4e50022d9679219e6987b"
    ...
    config.dataset = d(
        name='ISIC2018_Features',
        # path='/storage/U-ViT/assets/datasets/ChestXray14-256_features-BiomedCLIP', # debug
        path=f'assets/datasets/ISIC2018-{config.resolution}_features-{config.model_name_or_path}',
        cfg=True,
        p_uncond=0.1
    )
    # train
    ...
    config.sample = d(
        ...
        cfg=True,
        scale=1.,
        path=f'sample/ISIC2018-t2i-{config.resolution}_features-{config.model_name_or_path}/eval',
    )
