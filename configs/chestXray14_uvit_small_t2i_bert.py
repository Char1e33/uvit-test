...
def get_config():
    ...
    config.dataset = d(
        ...
        path=f'assets/datasets/ChestXray14-{config.resolution}_features-{config.model_name_or_path}',
        cfg=True,
        p_uncond=0.1
    )
    # train
    ...
    config.sample = d(
        ...
        cfg=True,
        scale=1.,
        path=f'sample/ChestXray-t2i-{config.resolution}_features-{config.model_name_or_path}/eval',
    )
